...
const PATH_SRC := 0
const PATH_NW := Vector2i(12, 0); const PATH_N := Vector2i(13, 0); const PATH_NE := Vector2i(14, 0)
const PATH_W  := Vector2i(12, 1); const PATH_C := Vector2i(13, 1); const PATH_E  := Vector2i(14, 1)
const PATH_SW := Vector2i(12, 2); const PATH_S := Vector2i(13, 2); const PATH_SE := Vector2i(14, 2)
