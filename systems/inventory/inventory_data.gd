...
func setup_default_inventory() -> void:
	...
	carrot_seeds.icon_texture = _get_seed_bag_icon(0, 0)       # Col 0, Row 0
	...
	strawberry_seeds.icon_texture = _get_seed_bag_icon(16, 0)  # Col 1, Row 0
	...
	tomato_seeds.icon_texture = _get_seed_bag_icon(32, 0)      # Col 2, Row 0
	...
	melon_seeds.icon_texture = _get_seed_bag_icon(48, 0)       # Col 3, Row 0
	...
	pumpkin_seeds.icon_texture = _get_seed_bag_icon(64, 0)     # Col 4, Row 0
	...
	beetroot_seeds.icon_texture = _get_seed_bag_icon(80, 0)    # Col 5, Row 0
...
func _get_seed_bag_icon(seed_x: int, seed_y: int) -> AtlasTexture:
	# Usa seeds.png que nao tem contorno branco
	var texture = load("res://assets/sprites/seeds/seeds.png") as Texture2D
	if texture == null:
		return null
	var tex = AtlasTexture.new()
	tex.atlas = texture
